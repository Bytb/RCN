...
from experiments.GAT.Simulations.Data.PolBooks import load_polbooks_graph
    ...
    for seed in SEEDS:
        ...
        for epoch in range(1, 201):
            ...
            loss = combined_community_loss(
                ...
                lambda_mod=0.6,
                lambda_lap=1e-3,  # Laplacian/L2 (in-loss)
                lambda_contrast=1e-5,
                lambda_orth=1e-3,
                contrast_tau=0.5,
...
if __name__ == "__main__":
    ...
    # === Load Dataset ===
    x, edge_index, y, edge_weight, G = load_polbooks_graph(use_onehot=True, device=device)
