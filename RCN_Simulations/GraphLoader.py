...
def load_graph(use_onehot=False, device="cpu"):
    # === Load gpickle ===
    with open(r"C:\Users\Caleb\Desktop\RCN Project\GNN-Advanced-Community-Detection\experiments\GAT\Data\Graphs\facebook_graph.gpickle", "rb") as f:
        G = pickle.load(f)
